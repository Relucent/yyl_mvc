...
import yyl.mvc.plugin.hibernate.HibernateGenericDao;
import yyl.mvc.plugin.hibernate.session.DefaultHibernateSessionProviderImpl;
import yyl.mvc.plugin.hibernate.session.HibernateSessionProvider;
