/**
 * $RCSfile$ $Revision: 3657 $ $Date: 2002-09-09 08:31:31 -0700 (Mon, 09 Sep 2002) $ Adapted from Markus Hahn's Blowfish package so that all
 * functionality is in a single source file. Please visit the following URL for his excellent package: http://www.hotpixel.net/software.html Copyright
 * (c) 1997-2002 Markus Hahn <markus_hahn@gmx.net> Released under the Apache 2.0 license.
 */
 ...
 * @author Markus Hahn <a href="markus_hahn@gmx.net">markus_hahn@gmx.net</a>
...
public class Blowfish {
    ...
    private static class BlowfishECB {
        ...
        final static int pbox_init[] = {0x243f6a88, 0x85a308d3, 0x13198a2e, 0x03707344, 0xa4093822, 0x299f31d0, 0x082efa98, 0xec4e6c89, 0x452821e6,
                0x38d01377, 0xbe5466cf, 0x34e90c6c, 0xc0ac29b7, 0xc97c50dd, 0x3f84d5b5, 0xb5470917, 0x9216d5d9, 0x8979fb1b};

        final static int sbox_init_1[] = {0xd1310ba6, 0x98dfb5ac, 0x2ffd72db, 0xd01adfb7, 0xb8e1afed, 0x6a267e96, 0xba7c9045, 0xf12c7f99, 0x24a19947,
     ...
     * @param nSrcPos from which character in the string the conversion should begin, remember that (nSrcPos modulo 2) should equals 0 normally
