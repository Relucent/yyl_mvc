...
public class LdapRestrictions {
	...
	public static abstract interface LFilter {
	...
	protected static abstract class AbstractBinaryLogicalFilter extends AbstractBaseFilter {
		...
		public boolean equals(Object obj) {
			if (((obj instanceof AbstractBinaryLogicalFilter)) && (getClass() == obj.getClass())) {
	...
	static abstract class AbstractCompareFilter extends AbstractBaseFilter {
		...
		public boolean equals(Object o) {
			if (((o instanceof AbstractCompareFilter)) && (o.getClass() == getClass())) {
				AbstractCompareFilter that = (AbstractCompareFilter) o;
	...
	public static class LFilterNot extends AbstractBaseFilter {
		...
		public boolean equals(Object o) {
			if (((o instanceof LFilterNot)) && (o.getClass() == getClass())) {
				LFilterNot f = (LFilterNot) o;
	...
	public static class LFilterNe extends AbstractBaseFilter {
		...
		@Override
		public boolean equals(Object o) {
			if (((o instanceof LFilterNe)) && (o.getClass() == getClass())) {
				LFilterNe f = (LFilterNe) o;
				return this.filter.equals(f.filter);
			}
			return false;
		}
