package yyl.mvc.util.constants;
...
public class CharConstants {
    ...
    /** 中文(全角)逗号 */
    public static final char FULL_WIDTH_COMMA = '，';

    /** 中文(全角)冒号 */
    public static final char FULL_WIDTH_COLON = '：';

    /** 中文(全角)分号 */
    public static final char FULL_WIDTH_SEMICOLON = '；';
